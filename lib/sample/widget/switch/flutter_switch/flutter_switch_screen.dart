 ...
 * freuss47@gmail.com
 */
class FlutterSwitchScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FlutterSwitchScreenState();
  }
}

class _FlutterSwitchScreenState extends BaseStatefulState<FlutterSwitchScreen> {
  @override
  void initState() {
    super.initState();
  }
                ...
                Row(
                  ...
                  children: <Widget>[
                    FlutterSwitch(
                      ...
                      inactiveTextColor: Colors.blue.withOpacity(0.5),
                      value: status3,
                      onToggle: (val) {
                        setState(() {
                          status3 = val;
