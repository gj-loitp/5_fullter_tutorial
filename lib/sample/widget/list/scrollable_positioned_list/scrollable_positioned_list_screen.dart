...
class ScrollablePositionedListScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ScrollablePositionedListScreenState();
  }
}

class _ScrollablePositionedListScreenState
    extends BaseStatefulState<ScrollablePositionedListScreen> {
  @override
  void initState() {
    super.initState();
  }
