...
class AnimatedBottomNavigationBarScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _AnimatedBottomNavigationBarScreenState();
  }
}

class _AnimatedBottomNavigationBarScreenState
    extends BaseStatefulState<AnimatedBottomNavigationBarScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MyHomePage(title: "animated_bottom_navigation_bar"),
    );
  }
}
