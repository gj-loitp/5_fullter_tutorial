 ...
 * freuss47@gmail.com
 */
class FlutterSnakeNavigationbarScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FlutterSnakeNavigationbarScreenState();
  }
}

class _FlutterSnakeNavigationbarScreenState
    extends BaseStatefulState<FlutterSnakeNavigationbarScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SnakeNavigationBarExampleScreen(),
    );
  }
}
