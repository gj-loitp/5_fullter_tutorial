 ...
 * freuss47@gmail.com
 */
class FlutterImageCompressScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FlutterImageCompressScreenState();
  }
}

class _FlutterImageCompressScreenState
    extends BaseStatefulState<FlutterImageCompressScreen> {
  @override
  void initState() {
    super.initState();
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> compress() async {
    final img = AssetImage('assets/images/img.jpg');
    print('pre compress');
  ...
  Future compressListExample() async {
    final data = await rootBundle.load('assets/images/img.jpg');
          ...
          slivers: <Widget>[
            SliverToBoxAdapter(
              child: AspectRatio(
                ...
                child: DecoratedBox(
                  ...
                  child: Image(
                    image: provider ?? AssetImage('assets/images/img.jpg'),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
            ...
            SliverToBoxAdapter(
              child: TextButton(
                ...
                onPressed: () => testCompressAsset('assets/images/img.jpg'),
              ),
            ),
            SliverToBoxAdapter(
              child: TextButton(
