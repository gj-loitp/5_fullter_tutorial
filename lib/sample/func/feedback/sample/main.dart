...
class MyAppFeedback extends StatefulWidget {
  const MyAppFeedback({Key? key}) : super(key: key);

  @override
  State<MyAppFeedback> createState() => _MyAppFeedbackState();
}

bool _useCustomFeedback = false;

class _MyAppFeedbackState extends State<MyAppFeedback> {
  @override
  Widget build(BuildContext context) {
    return BetterFeedback(
      ...
      child: MaterialApp(
        title: 'Feedback Demo',
        theme: ThemeData(
          primarySwatch: _useCustomFeedback ? Colors.green : Colors.deepOrange,
        ),
